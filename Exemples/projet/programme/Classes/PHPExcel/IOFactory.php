...
class PHPExcel_IOFactory
{
    ...
    private static $searchLocations = array(
        array( 'type' => 'IWriter', 'path' => 'PHPExcel/Writer/{0}finale.php', 'class' => 'PHPExcel_Writer_{0}' ),
        array( 'type' => 'IReader', 'path' => 'PHPExcel/Reader/{0}finale.php', 'class' => 'PHPExcel_Reader_{0}' )
    );
     ...
     * @param    string $location    Example: PHPExcel/Writer/{0}finale.php
